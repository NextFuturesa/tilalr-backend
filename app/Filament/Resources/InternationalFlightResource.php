            ...
            ->schema([
                Forms\Components\Section::make('Flight Details')
                    ->schema([
                        ...
                        Forms\Components\TextInput::make('stops_zh')->label('Stops (ZH)'),
